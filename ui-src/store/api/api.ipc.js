    ...
    if (ipc) {
      switch (action.type) {
        ...
        case 'ApiGetTreeDataState':
          ipc.send('client:GetTreeDataState', {});
          break;
        case 'ApiSetTreeDataState':
          ipc.send('client:SetTreeDataState', action.data);
          break;
        case 'ApiGetSnipData':
          ipc.send('client:GetSnipData', {});
          break;
        case 'ApiSetSnipData':
        ...
        case 'ApiSetClipboard':
          clipboard.writeText(action.copyText);
          break;
        default: break;
      }
    }
