...
export default class TreeViewActions {
  ...
  clickHandler = (buttonid) => {
    switch (buttonid) {
      ...
      case 'saveNewBefore':
      case 'saveNewChild':
        this.ngRedux.dispatch(saveTreeNew(this.itemDetail, buttonid));
        break;
      case 'cancelNew':
        this.showNew = false;
        break;
      case 'saveEdit':
        this.ngRedux.dispatch(saveTreeEdit(this.itemDetail));
        break;
      case 'cancelEdit':
        this.showEdit = false;
        break;
      default:
        this.ngRedux.dispatch(treeActions(buttonid, this.currentItem));
    }
  };
  startNew = () => {
...
TreeViewActions.parameters = [[NgRedux]];
